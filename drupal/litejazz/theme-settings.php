...
function litejazz_form_system_theme_settings_alter(&$form, $form_state){
 ...
 $form['litejazz_style'] = array(
    ...
    '#default_value' => theme_get_setting('litejazz_style', $theme),
    '#options' => array(
      'red' => t('Red'),
      'green' => t('Green'),
      'blue' => t('Blue'),
  ...
  $form['litejazz_themelogo'] = array(
    ...
    '#default_value' => theme_get_setting('litejazz_themelogo', $theme),
  );
  ...
  $form['litejazz_pickstyle'] = array(
    ...
    '#default_value' => theme_get_setting('litejazz_pickstyle', $theme),
  );
  ...
  $form['litejazz_width'] = array(
    ...
    '#default_value' => theme_get_setting('litejazz_width', $theme),
    '#size' => 7,
    '#maxlength' => 7,
  );
  ...
  $form['litejazz_breadcrumb'] = array(
    ...
    '#default_value' => theme_get_setting('litejazz_breadcrumb', $theme),
  );
  ...
  $form['litejazz_fontfamily'] = array(
    ...
    '#default_value' => theme_get_setting('litejazz_fontfamily', $theme),
    '#options' => array(
  ...
  $form['litejazz_customfont'] = array(
    ...
    '#default_value' => theme_get_setting('litejazz_customfont', $theme),
    '#size' => 40,
    '#maxlength' => 75,
  );
  ...
  $form['litejazz_uselocalcontent'] = array(
    ...
    '#default_value' => theme_get_setting('litejazz_uselocalcontent', $theme),
  );
  ...
  $form['litejazz_localcontentfile'] = array(
    ...
    '#default_value' => theme_get_setting('litejazz_localcontentfile', $theme),
    '#size' => 40,
    '#maxlength' => 75,
  );
  ...
  $form['litejazz_leftsidebarwidth'] = array(
    ...
    '#description' => t('Set the width in Pixel or %.'),
    '#default_value' => theme_get_setting('litejazz_leftsidebarwidth', $theme),
    '#size' => 5,
    '#maxlength' => 5,
  );
  ...
  $form['litejazz_rightsidebarwidth'] = array(
    ...
    '#description' => t('Set the width in Pixel or %.'),
    '#default_value' => theme_get_setting('litejazz_rightsidebarwidth', $theme),
    '#size' => 5,
    '#maxlength' => 5,
  );
  ...
  $form['litejazz_suckerfish'] = array(
    ...
    '#default_value' => theme_get_setting('litejazz_suckerfish', $theme),
  );

  $form['litejazz_usecustomlogosize'] = array(
    '#type' => 'checkbox',
    '#title' => t('Specify Custom Logo Size'),
    '#default_value' => theme_get_setting('litejazz_usecustomlogosize', $theme),
  );
  ...
  $form['litejazz_logowidth'] = array(
    ...
    '#default_value' => theme_get_setting('litejazz_logowidth', $theme),
    '#size' => 5,
    '#maxlength' => 5,
  );
  ...
  $form['litejazz_logoheight'] = array(
    ...
    '#title' => t('Logo Height'),
    '#description' => t('Set the width in Pixel.'),
    '#default_value' => theme_get_setting('litejazz_logoheight', $theme),
    '#size' => 5,
    '#maxlength' => 5,
  );
  ...
  $form['litejazz_banner'] = array(
    ...
    '#default_value' => theme_get_setting('litejazz_banner', $theme),
  );
  return $form;
}
